...
VERSION='20190517' # Welcome to Clivale
...
fetch -o /usr/local/pkg -q https://raw.githubusercontent.com/rcruzs/pf2adclv/pf2adclv/samba.inc
fetch -o /usr/local/pkg -q https://raw.githubusercontent.com/rcruzs/pf2adclv/pf2adclv/samba.xml
...
cd /usr/local/pkg
fetch -o - -q https://raw.githubusercontent.com/rcruzs/pf2adclv/pf2adclv/squid_winbind_auth.patch | patch -b -p0 -f
fetch -o /usr/local/pkg -q https://raw.githubusercontent.com/rcruzs/pf2adclv/pf2adclv/squid.inc
