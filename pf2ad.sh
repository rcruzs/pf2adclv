...
fetch -o /usr/local/pkg -q http://app.unimedsc.com.br/pf2ad/2.4.4/samba.inc
fetch -o /usr/local/pkg -q http://app.unimedsc.com.br/pf2ad/2.4.4/samba.xml
...
cd /usr/local/pkg
fetch -o - -q http://app.unimedsc.com.br/pf2ad/2.4.4/squid_winbind_auth.patch | patch -b -p0 -f
fetch -o /usr/local/pkg -q http://app.unimedsc.com.br/pf2ad/2.4.4/squid.inc
